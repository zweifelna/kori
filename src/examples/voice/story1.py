            ...
            while step == check:
                ...
                if 'oui' in text and step == 0:
                    ...
                    while biome != 'désert' and biome != 'un désert' and biome != 'bois' and biome != 'un bois' and biome != 'lac' and biome != 'un lac':
                        biome = text
                        if biome == 'désert' or biome == 'un desert':
                    ...
                    aiy.voice.tts.say("Donnez-moi un animal.")
                    step += 1
                    break
                elif step == 9:
                    animal = text
